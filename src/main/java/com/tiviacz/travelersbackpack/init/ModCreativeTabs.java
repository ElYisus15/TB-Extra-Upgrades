...
public class ModCreativeTabs {
    ...
    public static void displayItems(CreativeModeTab.ItemDisplayParameters displayParameters, CreativeModeTab.Output output) {
        ...
        output.accept(ModItems.ALLTHEMODIUM_TIER_UPGRADE.get());
        output.accept(ModItems.VIBRANIUM_TIER_UPGRADE.get());
        output.accept(ModItems.UNOBTAINIUM_TIER_UPGRADE.get());
        ...
        output.accept(createTieredBackpack(Tiers.ALLTHEMODIUM));
        output.accept(createTieredBackpack(Tiers.VIBRANIUM));
        output.accept(createTieredBackpack(Tiers.UNOBTAINIUM));
